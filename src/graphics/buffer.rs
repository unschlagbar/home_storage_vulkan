...
use super::{UniformBufferObject, vulkan_render::MAXFRAMESINFLIGHT};

pub fn create_uniform_buffers(
    base: &VkBase,
) -> (
    [graphics::Buffer; MAXFRAMESINFLIGHT],
    [*mut c_void; MAXFRAMESINFLIGHT],
) {
    ...
    for i in 0..MAXFRAMESINFLIGHT {
        uniform_buffers[i] = graphics::Buffer::create(
            base,
            buffer_size,
            vk::BufferUsageFlags::UNIFORM_BUFFER,
            vk::MemoryPropertyFlags::HOST_VISIBLE | vk::MemoryPropertyFlags::HOST_COHERENT,
        );
        mapped[i] = uniform_buffers[i].map_memory(&base.device, buffer_size, 0) as _;
    }
