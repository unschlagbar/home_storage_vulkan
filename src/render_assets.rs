...
impl RenderAssets {
    pub fn init(&mut self, renderer: &mut VulkanRender) {
        ...
        let data = {
            ...
            renderer.resources.texture_atlas.get_pngs(path)
        };

        renderer.resources.texture_atlas.load_directory(
            data,
            &renderer.base,
            MemType::DeviceLocal as usize,
            renderer.cmd_pool,
            &mut renderer.resources.mem_manager,
        );
        ...
        {
            let buffer_size;
            (*buffer, buffer_size) = resources.mem_manager.create_buffer(
                base,
                0,
            ...
            let mem = &resources.mem_manager.memory_pool[0];
        ...
        resources.add_mat(Material::new::<UiInstance>(
            base,
            window_size,
            render_pass,
            &[ubo_layout],
        ...
        resources.add_mat(Material::new::<AtlasInstance>(
            base,
            window_size,
            render_pass,
        ...
        resources.add_mat(Material::new::<ShadowInstance>(
            base,
            window_size,
            render_pass,
            &[ubo_layout],
        ...
        resources.add_mat(Material::new::<MSDFInstance>(
            base,
            window_size,
            render_pass,
            &[ubo_layout, img_layout],
        ...
        resources.create_desc_sets(
            ...
            resources.texture_atlas.atlas.as_ref().unwrap().view,
        );
    ...
    fn create_font_atlas(
        ...
        renderer.resources.mem_manager.upload_image(
            &renderer.base,
            1,
            renderer.cmd_pool,
            &mut image,
