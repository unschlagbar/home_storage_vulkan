use iron_oxide::{
    ...
    ui::{
        AbsoluteLayout, Align, Button, ButtonState, CallContext, Container, DirtyFlags,
        ElementBuild, ErasedFnPointer, OutArea, Text, UiState, UiUnit::*,
    },
};
...
pub fn build_main() -> UiState {
    ...
    state.add_element(AbsoluteLayout {
